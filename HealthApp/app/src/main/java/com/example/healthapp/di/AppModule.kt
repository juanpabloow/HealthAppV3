...
import com.example.healthapp.mood.data.repository.FirebaseMoodRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindMoodRepository(impl: FirebaseMoodRepositoryImpl): MoodRepository
}
